...
public class MapleTreeGenerator extends WorldGenAbstractTree {
    public static final IBlockState LOG = MoonshinersBlocks.BLOCK_LOG.getDefaultState().withProperty(CustomBlockLog.VARIANT, TreeType.MAPLE);
    public static final IBlockState LEAF = MoonshinersBlocks.BLOCK_LEAVES.getDefaultState().withProperty(CustomBlockLog.VARIANT, TreeType.MAPLE);

    private int minHeight;

    public MapleTreeGenerator() {
        super(false);
        this.minHeight = 4;
    }
