...
public class ContainerCopperFurnace extends Container {
    ...
    public ContainerCopperFurnace(InventoryPlayer player, TileEntityCopperFurnace tileEntity) {
        ...
        this.addSlotToContainer(new SlotItemHandler(handler, 0, 26, 17));
        this.addSlotToContainer(new SlotItemHandler(handler, 1, 44, 17));
        this.addSlotToContainer(new SlotItemHandler(handler, 2, 35, 53));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 3) {
                ...
                if (!CopperFurnaceRecipes.getInstance().getSmeltingResult(stack1, slot1.getStack()).isEmpty()) {
                    if (!this.mergeItemStack(stack1, 0, 2, false)) {
                        return ItemStack.EMPTY;
                    } else if (TileEntityCopperFurnace.isItemFuel(stack1)) {
