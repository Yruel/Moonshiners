...
public class TileEntityCopperFurnace extends TileEntity implements IInventory, ITickable {
    ...
    private boolean canSmelt() {
        if (this.inventory.get(0).isEmpty() || this.inventory.get(1).isEmpty()) return false;
            ...
            ItemStack result = CopperFurnaceRecipes.getInstance().getSmeltingResult(this.inventory.get(0), this.inventory.get(1));
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            ItemStack result = CopperFurnaceRecipes.getInstance().getSmeltingResult(input1, input2);
            ItemStack output = this.inventory.get(3);
    ...
    public String getGuiID() {
        return "moonshiners:copper_furnace";
    }
