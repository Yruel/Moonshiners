...
public class CustomFluidTank extends FluidTankBase implements IFluidHandlerItem {

    protected final ItemStack stack;

    CustomFluidTank(ItemStack stack, int capacity) {
        super(capacity);
        this.stack = stack;
    }
    ...
    public FluidTank readFromNBT(NBTTagCompound nbt) {
        fluid = nbt == null || nbt.hasKey("tank") ? null : FluidStack.loadFluidStackFromNBT(nbt);
        return this;
    }
    ...
    public static class CapabilityProvider extends CustomFluidTank implements ICapabilityProvider {
